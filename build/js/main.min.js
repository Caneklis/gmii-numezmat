...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var eventsSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".events__slider.swiper-container", {
    slidesPerView: 1,
    spaceBetween: 10,
    pagination: {
      el: ".swiper-pagination",
  ...
  var collectionFavorites = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".main-page-collection__favorites-slider", {
    effect: "coverflow",
    grabCursor: true,
    centeredSlides: true,
    initialSlide: 2,
    ...
    on: {
      slideChange: function slideChange() {
        ...
        $(".swiper-slide").removeClass("swiper-slide-prev-2 swiper-slide-next-2");
        $('.swiper-slide[data-swiper-slide-index="' + realIndex + '"]').prev().prev().addClass("swiper-slide-prev-2");
        $('.swiper-slide[data-swiper-slide-index="' + realIndex + '"]').next().next().addClass("swiper-slide-next-2");
      }
    }
  }); // (function () {
  //   "use strict";
  ...
  function swiperMode() {
    ...
    if (mobile.matches) {
      if (!init) {
        ...
        init = true;
        swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".main-page-news__slider.swiper-container", (_Swiper = {
          // centeredSlides: true,
          slidesPerView: "auto",
          loop: true,
          spaceBetween: 56,
