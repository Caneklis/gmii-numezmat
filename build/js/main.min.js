...
__webpack_require__(/*! ./modules/bvi */ "./js/modules/bvi.js");

__webpack_require__(/*! ./theta-carousel.min */ "./js/theta-carousel.min.js");

document.addEventListener("DOMContentLoaded", function () {
  __webpack_require__(/*! ./modules/main-nav */ "./js/modules/main-nav.js");

  var searchFormToggle = document.querySelector(".search-form__toggle-btn");
  var searcForm = document.querySelector(".search-form");
  searchFormToggle.addEventListener("click", function () {
    var expanded = searchFormToggle.getAttribute("aria-expanded") === "true";
  ...
  document.addEventListener("click", function (e) {
    var target = e.target;
    var its_menu = target == searcForm || searcForm.contains(target); // const its_btnMenu = target == btnMenu;

    var menu_is_active = searcForm.classList.contains("search-form--open");
  ...
  var yearsBtn = document.querySelector(".years-toggle");
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#flesh").mousemove(function (e) {
    currentMousePos.x = e.pageX;
    currentMousePos.y = e.pageY;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#bone").css("-webkit-mask-position-x", currentMousePos.x - 75);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#bone").css("-webkit-mask-position-y", currentMousePos.y - 75);
  });
  ...
  if (document.querySelector(".promo__title")) {
    setTimeout(function () {
      document.querySelector(".promo__title").addEventListener("mousemove", function (e) {
        var w = e.offsetWidth; // let x = 360*(e.offsetX/e.offsetY) / w;

        var x = e.offsetX; // console.log(x);

        var style = "-webkit-linear-gradient(\n        45deg,\n        rgba(200, 193, 188, 1) ".concat(e.offsetX / e.offsetY, "%,\n        rgba(185, 154, 133, 1) ").concat(e.offsetX / e.offsetY * 3, "%,\n        rgba(253, 178, 98, 1) ").concat(e.offsetX / e.offsetY * 8, "%,\n        rgba(192, 171, 158, 1) ").concat(e.offsetX / e.offsetY * 13, "%,\n        rgba(200, 193, 188, 1) ").concat(e.offsetX / e.offsetY * 18, "%\n      )"); // console.log(style);
  ...
  var eventsSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](".events__slider.swiper-container", {
    slidesPerView: 1,
    spaceBetween: 10,
    pagination: {
      el: ".swiper-pagination",
  ...
  var collectionFavorites = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](".main-collection__swiper-slider", {
    grabCursor: true,
    centeredSlides: true,
    initialSlide: 1,
    slidesPerView: 1,
  ...
  var personsSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](".department__header-slider", {
    grabCursor: true,
    centeredSlides: true,
    initialSlide: 1,
    slidesPerView: 1,
  ...
  function swiperMode() {
    ...
    var tablet = window.matchMedia("(min-width: 768px)"); // Enable (for mobile)
    ...
    if (mobile.matches) {
      if (!init) {
        ...
        init = true;
        swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](".main-page-news__slider.swiper-container", (_Swiper = {
          // centeredSlides: true,
          slidesPerView: "auto",
          loop: true,
          spaceBetween: 56,
          watchSlidesVisibility: true
        }, _defineProperty(_Swiper, "loop", true), _defineProperty(_Swiper, "direction", "horizontal"), _defineProperty(_Swiper, "grabCursor", true), _defineProperty(_Swiper, "autoHeight", true), _defineProperty(_Swiper, "loop", false), _defineProperty(_Swiper, "a11y", true), _defineProperty(_Swiper, "keyboardControl", true), _Swiper));
      }
    } // Disable (for tablet)
  ...
  var columnSlider = document.querySelectorAll(".column-content");
  columnSlider.forEach(function (element) {
    var sliderTop = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](element.querySelector(".gallery-top"), {
      spaceBetween: 0,
      navigation: {
    ...
    var sliderThumbs = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](element.querySelector(".gallery-thumbs"), {
      spaceBetween: 0,
      centeredSlides: false,
      slidesPerView: "auto",
      touchRatio: 0.2,
  ...
  var gallerySlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](".gallery-slider", {
    spaceBetween: 0,
    navigation: {
      nextEl: ".swiper-button-next",
      prevEl: ".swiper-button-prev"
  ...
  var collectionSlider = document.querySelectorAll(".collections__items-slider");
  collectionSlider.forEach(function (element) {
    var slider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](element.querySelector(".swiper-container"), {
      slidesPerView: 1,
      spaceBetween: 10,
      navigation: {
        nextEl: element.querySelector(".swiper-button-next"),
  ...
  var personSlider = document.querySelectorAll(".department__person-photo");
  personSlider.forEach(function (element) {
    var sliderTop = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](element.querySelector(".department__person-slider"), {
      initialSlide: 0,
      spaceBetween: 0,
      slidesPerView: 1,
      centeredSlides: false,
    ...
    var sliderThumbs = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](element.querySelector(".department__person-slider-thumbs"), {
      initialSlide: 0,
      slidesPerView: "auto",
      spaceBetween: 17,
      slideToClickedSlide: true,
  ...
  var catalogDirectoryBtn = document.querySelector(".directory__switcher-btn--category");
  var catalogAlphabetBtn = document.querySelector(".directory__switcher-btn--alphabet");
  var alphabetFilterList = document.querySelector(".directory__alphabet-list");
  var alphabetList = document.querySelector(".directory__alphabet-main-list");
  var categoryList = document.querySelector(".directory__category-main-list");

  if (catalogDirectoryBtn) {
    catalogDirectoryBtn.addEventListener("click", function () {
  ...
  if (catalogAlphabetBtn) {
    catalogAlphabetBtn.addEventListener("click", function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter__form__custom-select").each(function () {
    ...
    template += '<span class="filter__form__custom-select-trigger">' + jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr("data-placeholder") + "</span>";
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find("option").each(function () {
      template += '<span class="filter__form__custom-option ' + jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr("class") + '" data-value="' + jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr("value") + '">' + jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).html() + "</span>";
    });
    template += "</div></div>";
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).wrap('<div class="filter__form__custom-select-wrapper"></div>');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).after(template);
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter__form__custom-option:first-of-type").hover(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parents(".filter__form__custom-options").addClass("option-hover");
  }, function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parents(".filter__form__custom-options").removeClass("option-hover");
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter__form__custom-select-trigger").on("click", function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("html").one("click", function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter__form__custom-select").removeClass("opened");
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parents(".filter__form__custom-select").toggleClass("opened");
    event.stopPropagation();
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter__form__custom-option").on("click", function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parents(".filter__form__custom-select-wrapper").find("select").val(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data("value"));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parents(".filter__form__custom-options").find(".filter__form__custom-option").removeClass("selection");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass("selection");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parents(".filter__form__custom-select").removeClass("opened");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parents(".filter__form__custom-select").find(".filter__form__custom-select-trigger").text(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).text());
  });
  ...
  function carouselCreated(e, data) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(z).animate({
      z: -1450
    }, {
      easing: "easeOutQuad",
      duration: 1000,
      step: function step(val) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".theta-carousel").theta_carousel({
  ...
  var container = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#container"); // // fade in effect
  // container.css({
  //   opacity: 0,
  // });
...
var require;var require;!function t(e, i, s) {
  function n(r, a) {
    if (!i[r]) {
      if (!e[r]) {
    ...
    e.exports = function (e) {
      ...
      return function (i, s) {
        var n = t("./W.js"),
            ...
            r = t("./../h1.js"),
            a = new n(i, {});
        this.k5 = new o(), this.k5.x = 1, this.k3 = new o(), this.k3.y = 1, e.extend(this, a), e.extend(this.settings, s), this.apply = function (t, e, i) {
          var s = this.e1.path.getPoint(i),
              n = this.e1.path.getPoint(i + .1),
              a = new o();
          a.e7(s, n);
          var h = a.angle(this.k5);
          h *= this.e1.options.allignElementsWithPathCoefficient, t.rotations.push(new r(this.k3, h));
        };
      };
    }(jQuery);
  }, {
  ...
  2: [function (t, e, i) {
    e.exports = function (t) {
      ...
      return function (e, i) {
        this.e1 = e, this.applyPhase = "positioning", this.settings = {}, t.extend(this.settings, i), this.Q = function () {
          return 0;
        }, this.apply = function (t, e, i) {}, this.revert = function () {};
      };
    }(jQuery);
  }, {}],
  3: [function (t, e, i) {
    e.exports = function (e) {
      ...
      return function (i, s) {
        var n = t("./W.js"),
            o = t("./../b4.js"),
            r = new n(i, {});
        e.extend(this, r), e.extend(this.settings, s), this.apply = function (t, e, i) {
          var s = this.e1.path.a2(),
              n = Math.abs(i - s),
              r = this.e1.options.distance * this.e1.options.fadeAwayNumberOfConfigurableElements,
              a = 1 - Math.min(n / r, 1),
              h = this.e1.options.fadeAwayBezierPoints,
              l = o(a, h.p1, h.p2, h.p3, h.p4).y;
          e.b5.css({
            opacity: l / 100
          });
        };
  ...
  4: [function (t, e, i) {
    e.exports = function (e) {
      ...
      return function (i, s) {
        var n = t("./W.js"),
            o = new n(i, {});
        e.extend(this, o), e.extend(this.settings, s), this.apply = function (t, e, i) {
          var s = Math.abs(i - this.e1.path.a2()),
              n = 1 - s / this.e1.options.distance;
          n = Math.max(n, 0), t.translateX += this.e1.options.popoutSelectedShiftX * n, t.translateY += this.e1.options.popoutSelectedShiftY * n, t.translateZ += this.e1.options.popoutSelectedShiftZ * n;
        };
      };
    }(jQuery);
  }, {
    ...
    e.exports = function (e) {
      ...
      return function (i, s) {
        var n = t("./W.js"),
            o = new n(i, {});
        e.extend(this, o), e.extend(this.settings, s), this.apply = function (t, e, i) {
          e.isReflectionApplied || (e.isReflectionApplied = !0, e.b5.css("box-reflect", "below " + this.e1.options.reflectionBelow + "px -webkit-gradient(linear, left top, left bottom, from(transparent), color-stop(" + (1 - this.e1.options.reflectionHeight) + ", transparent), to(black))"));
        }, this.revert = function () {
          for (var t = 0; t < this.e1.a2.length; t++) {
            this.e1.a2[t].isReflectionApplied = !1, this.e1.a2[t].b5.css("box-reflect", "");
          }
        };
      };
    }(jQuery);
    ...
    e.exports = function (e) {
      ...
      return function (i, s) {
        var n = t("./W.js"),
            ...
            a = t("./../h1.js"),
            h = new n(i, {});
        e.extend(this, h), e.extend(this.settings, s), this.apply = function (t, e, i) {
          var s = this.e1.path.a2(),
              n = Math.abs(i - s),
              h = this.e1.options.distance * this.e1.options.rotationNumberOfConfigurableElements,
              l = 1 - Math.min(n / h, 1),
              u = this.e1.options.rotationBezierPoints,
              c = o(l, u.p1, u.p2, u.p3, u.p4).y;
          i < s && this.e1.options.rotationInvertForNegative && (c *= -1);
          var p = new r();
          p.x = this.e1.options.rotationVectorX, p.y = this.e1.options.rotationVectorY, p.z = this.e1.options.rotationVectorZ, t.rotations.push(new a(p, c));
        };
      };
    }(jQuery);
  }, {
  ...
  7: [function (t, e, i) {
    e.exports = function (e) {
      ...
      return function (i, s) {
        var n = t("./W.js"),
            o = new n(i, {});
        e.extend(this, o), e.extend(this.settings, s), this.apply = function (t, i, s) {
          var n = "0px 0px " + this.e1.options.shadowBlurRadius + "px " + this.e1.options.shadowSpreadRadius + "px #000000",
              o = i.b5;
          this.e1.options.shadowSelector && (o = e(this.e1.options.shadowSelector, o)), o.css({
            "-webkit-box-shadow": n,
            "-moz-box-shadow": n,
            "box-shadow": n
          });
          ...
          for (var t = 0; t < this.e1.a2.length; t++) {
            var i = this.e1.a2[t].b5;
            this.e1.options.shadowSelector && (i = e(this.e1.options.shadowSelector, i)), i.css({
              "-webkit-box-shadow": "",
              "-moz-box-shadow": "",
              "box-shadow": ""
            });
    ...
    e.exports = function (e) {
      ...
      return function (i, s) {
        ...
        e.extend(this, r), e.extend(this.settings, s), this.apply = function (t, e, i) {
          var s = this.e1.path.a2(),
              n = Math.abs(i - s),
              r = this.e1.options.distance * this.e1.options.sizeAdjustmentNumberOfConfigurableElements,
              a = 1 - Math.min(n / r, 1),
              h = this.e1.options.sizeAdjustmentBezierPoints,
              l = o(a, h.p1, h.p2, h.p3, h.p4).y;
          t.scale = l / 100;
        };
      };
  ...
  9: [function (t, e, i) {
    e.exports = function (t) {
      ...
      function e(e) {
        e.Qz4 = function () {
          this.e1.options.autorotation ? this.Qz5() : (this.autorotationStarted = !1, this.autorotationTimer && clearTimeout(this.autorotationTimer));
        }, e.Qz5 = function () {
          this.autorotationStarted || (this.autorotationStarted = !!this.move());
        }, e.move = t.proxy(function () {
          return "left" == this.e1.options.autorotationDirection ? this.e1.moveBack() : "right" == this.e1.options.autorotationDirection ? this.e1.moveForward() : void 0;
        }, e), e.onMotionEnd = t.proxy(function () {
          this.autorotationStarted && (this.autorotationTimer && clearTimeout(this.autorotationTimer), this.autorotationTimer = setTimeout(this.move, this.e1.options.autorotationPause));
        }, e), e.destroy = function () {
          this.e1.widget().off("motionEnd", this.onMotionEnd);
        };
      }

      return function (t) {
        this.autorotationStarted = !1, this.e1 = t, this.autorotationTimer = null, e(this), this.e1.widget().on("motionEnd", this.onMotionEnd), this.Qz4();
      };
    }(jQuery);
  }, {}],
  10: [function (t, e, i) {
    ...
    e.exports = function (t) {
      ...
      return function (t, e, i, a, h) {
        ...
        return l.x = e.x * s(t) + i.x * n(t) + a.x * o(t) + h.x * r(t), l.y = e.y * s(t) + i.y * n(t) + a.y * o(t) + h.y * r(t), l;
      };
    }(jQuery);
  }, {}],
  11: [function (t, e, i) {
    e.exports = function (e) {
      ...
      function i(t, e, i, n) {
        for (var o = s(0, t, e, i, n), r = o.x, a = o.y, h = o.x, l = o.y, u = 0; u <= 20; u++) {
          var c = s(.05 * u, t, e, i, n);
          r = Math.min(c.x, r), a = Math.min(c.y, a), h = Math.max(c.x, h), l = Math.max(c.y, l);
        }
      ...
      return function (t, e, s, o) {
        var r = t.x + "." + t.y + "." + e.x + "." + e.y + "." + s.x + "." + s.y + "." + o.x + "." + o.y;
        return "undefined" == typeof n[r] && (n[r] = i(t, e, s, o)), n[r];
      };
    }(jQuery);
  }, {
    "./b4.js": 10
  ...
  12: [function (t, e, i) {
    t("./b3.js")(), function (e) {
      ...
      var i = t("./b2.js"),
          ...
          o = t("./b5.js"),
          r = t("./b9.js"),
          a = t("./rotation_logic_controller.js"),
          h = t("./endless_rotation_logic_controller.js"),
          l = t("./Qwq.js"),
          u = t("./Qz3.js"),
          c = t("./e6"),
          p = t("./e4.js"),
      ...
      e.theta.carousel = function (t, M) {
        var C = this;
        C.b5 = e(t), C.b5.data("theta.carousel", C), C.b5.addClass("theta-carousel"), C._create = function () {
          this.options = e.extend(!0, {}, e.theta.carousel.defaultOptions, M);
          var t = new c(this.widget().width(), this.widget().height());
          this.e6 = e('<div class="theta-carousel-inner-container"></div>'), this.e6.appendTo(this.widget()), this.e6.css({
            width: t.width + "px",
            height: t.height + "px"
          ...
          }), this.update(), this.h4 = [], this.g1(), this.g2(), this._createRotationLogicController(), this.b2 = new n(this), this.c3 = new s(this), this.b7(), this.f1 = new i(this), this._a3 = new r(this, e.proxy(this._k7, this)), this.c2 = new o(this), this.autoRotator = new u(this), e(this.f1).on("step", e.proxy(function (t, e) {
            this.b7(e);
          }, this)), e(this.f1).on("done", e.proxy(function (t, e) {
            this.e3(e), this.h2();
          }, this)), e(this._a3).on("end", e.proxy(function (t, e) {
            this.q8(e);
          }, this)), e(this._a3).on("start", e.proxy(this.e2, this)), this.initialized = !0;
        }, C.destroy = function () {
          for (var t = 0; t < this.h4.length; t++) {
            this.h4[t].revert();
          }

          null != this.q1 && this.q1.destroy(), this.c2.destroy(), this.c3.destroy(), this.b2.destroy(), this.autoRotator.destroy();

          for (var t = 0; t < this.a2.length; t++) {
            this.a2[t].b5.off("tap", this.moveTo), this.a2[t].b5.off("click", this.moveTo);
          }

          this.widget().data("theta.carousel", null);
        }, C.moveBack = function () {
          return this.q1.moveBack();
        }, C.moveForward = function () {
          return this.q1.moveForward();
        }, C.moveTo = function (t) {
          this.q1.moveTo(t);
          ...
          t.appendTo(this.e6), this.a2 = this.e6.children().filter(this.options.filter).map(function (t, i) {
            var s = e(i),
                n = s.data("theta-order");
            return n || (n = t), {
              b5: s,
              element: i,
              order: n
            };
          }).toArray(), this.a2.sort(function (t, e) {
            return t.order - e.order;
          });

          for (var i = 0; i < this.a2.length; i++) {
            if (this.a2[i].index = i, this.a2[i].element.index = i, !this.a2[i].b5.hasClass("theta-carousel-element")) {
              var s = e.proxy(function (t) {
                this.options.enabled && !this.options.autorotation && this.moveTo(t.index);
              }, this, this.a2[i].element);
              this.a2[i].b5.addClass("theta-carousel-element"), this.a2[i].b5.css({
                position: "absolute"
              }), this.a2[i].b5.on("tap", s), this.a2[i].b5.click(s);
            }
          }

          this.options.selectedIndex = Math.max(Math.min(this.options.selectedIndex, this.a2.length - 1), 0), 0 == this.a2.length && (this.options.selectedIndex = -1), this.initialized && (this.b2.update(), this.invalidate()), this.l1();
        }, C.getIsInMotion = function () {
          return this.b8;
        }, C.getIsFallbackMode = function () {
          return this.q1.wwa();
        }, C.widget = function () {
          return this.b5;
        }, C._setOption = function (t, e) {
          p.e5(C.options, t, e), "rotationAnimationDuration" !== t && "rotationAnimationEasing" !== t && ("filter" === t && this.update(), "perspective" === t && (this.e6.css({
            perspective: e + "px"
          }), "scale" == this.options.mode3D && this.b7()), 0 != t.indexOf("path") && "fallback" !== t || (this.g1(), this._createRotationLogicController(), this.b7()), "selectedIndex" !== t && "distance" !== t && "mode3D" !== t && "numberOfElementsToDisplayRight" !== t && "numberOfElementsToDisplayLeft" !== t && "scaleX" !== t && "scaleY" !== t && "scaleZ" !== t && "allignElementsWithPathCoefficient" !== t && "fadeAwayBezierPoints" !== t && "fadeAwayNumberOfConfigurableElements" !== t && "rotationBezierPoints" !== t && "rotationNumberOfConfigurableElements" !== t && "rotationInvertForNegative" !== t && "rotationVectorX" !== t && "rotationVectorY" !== t && "rotationVectorZ" !== t && "sizeAdjustmentNumberOfConfigurableElements" !== t && "sizeAdjustmentBezierPoints" !== t && "shadowBlurRadius" !== t && "shadowSpreadRadius" !== t && "popoutSelectedShiftX" !== t && "popoutSelectedShiftY" !== t && "popoutSelectedShiftZ" !== t && "distanceInFallbackMode" !== t || this.b7(), t.indexOf("autorotation") != -1 && this.autoRotator.Qz4(), t.indexOf("allignElementsWithPath") == -1 && t.indexOf("fadeAway") == -1 && t.indexOf("rotation") == -1 && t.indexOf("sizeAdjustment") == -1 && t.indexOf("shadow") == -1 && t.indexOf("popoutSelected") == -1 && t.indexOf("reflection") == -1 || (this.g2(), this.b7()), "selectedIndex" === t && this.l1());
        }, C._createRotationLogicController = function () {
          null != this.q1 && this.q1.destroy(), this.path.isEndless() ? this.q1 = new h(this) : this.q1 = new a(this), ("always" == this.options.fallback || "auto" == this.options.fallback && l.fallback()) && (this.q1 = new l(this, this.q1)), this.autoRotator && this.autoRotator.Qz4();
        }, C.g2 = function () {
          for (var t = 0; t < this.h4.length; t++) {
            this.h4[t].revert();
          }

          this.h4 = [], this.options.allignElementsWithPath && this.h4.push(new v(this, {})), this.options.fadeAway && this.h4.push(new w(this, {})), this.options.rotation && this.h4.push(new I(this, {})), this.options.sizeAdjustment && this.h4.push(new _(this, {})), this.options.shadow && this.h4.push(new j(this, {})), this.options.popoutSelected && this.h4.push(new b(this, {})), this.options.reflection && this.h4.push(new E(this, {}));
        }, C.g1 = function () {
          var t = null;
          if ("parabola" == this.options.path.type && (t = new x(this, this.options.path.settings)), "line" == this.options.path.type && (t = new y(this, this.options.path.settings)), "cubic" == this.options.path.type && (t = new f(this, this.options.path.settings)), "archimedes_spiral" == this.options.path.type && (t = new d(this, this.options.path.settings)), "ellipse" == this.options.path.type && (t = new g(this, this.options.path.settings)), "cubic_bezier" == this.options.path.type && (t = new m(this, this.options.path.settings)), null == t) throw "path " + this.options.path.type + " is not supported.";
          ...
          for (var t = 0; t < this.a2.length; t++) {
            t === this.options.selectedIndex ? this.a2[t].b5.addClass("theta-current-item") : this.a2[t].b5.removeClass("theta-current-item");
          }
        }, C.e2 = function () {
          this.b8 = !0, this.widget().addClass("theta-in-motion"), this.widget().trigger("motionStart", {
            index: this.options.selectedIndex
          });
        }, C.h2 = function () {
          this.c2.h3(!1), this.widget().removeClass("theta-in-motion"), this.b8 = !1, this.widget().trigger("motionEnd", {
            index: this.options.selectedIndex
          });
        }, C.e3 = function (t) {
          this.options.selectedIndex != t && (this.options.selectedIndex = t, this.k8()), this.b7();
        }, C._k7 = function (t) {
          return this.q1.consumeMotion(t);
        }, C.q8 = function (t) {
          this.q1.handleMotionEnd(t);
        }, C.b7 = function (t) {
          return this.q1.alignElements(t);
        }, C.b9 = function () {
          var t = e(".theta-carousel-inner-container", this.widget());
          return new c(t.width(), t.height());
        }, C._create();
      }, e.theta.carousel.defaultOptions = C, e.theta.carousel.version = M, e.fn.theta_carousel = function (t) {
        var i = arguments,
            s = !1,
            n = null,
            o = this.each(function () {
          var o = e(this),
              r = o.data("theta.carousel");
          if (r) {
            if ("string" == typeof t) {
              if ("function" == typeof r[t]) {
                var a = Array.prototype.slice.call(i, 1);
                s = !0, n = r[t].apply(r, a);
              }

              "option" == t && (2 == i.length && (s = !0, n = p.e6(r.options, i[1])), 3 == i.length && r._setOption(i[1], i[2]));
            } else {
              var h = e.extend(!0, {}, t);
              e.each(h, e.proxy(o.data("theta.carousel")._setOption, o.data("theta.carousel")));
            }
    ...
    "./b3.js": 14,
    "./c1.js": 15,
    "./endless_rotation_logic_controller.js": 16,
    "./Qwq.js": 17,
    "./b6.js": 18,
    "./b5.js": 20,
    "./b9.js": 21,
    ...
    "./paths/a8.js": 27,
    "./paths/e5.js": 28,
    "./rotation_logic_controller.js": 31,
    "./e6": 32,
    "./e4.js": 34
  }],
  13: [function (t, e, i) {
    e.exports = function (t) {
      ...
      return function (e) {
        this.e1 = e, this.k3 = !1, this.h5 = null, this.queue = [], this.distance = [], this.h7 = null, this.R = function () {
          this.queue = [], this.distance = [];
        }, this.animate = function (t, e, i, s, n) {
          "undefined" == typeof s && (s = null), "undefined" == typeof n && (n = null), this.addDistance(Math.abs(e - t)), this.queue.length > 5 || (this.queue.push({
            from: t,
            to: e,
            k5: i,
            easing: s,
          ...
          null != this.h7 && this.h7.stop(!0, !0);
        }, this.h6 = function () {
          if (this.queue.length > 0) {
            var e = this.queue[0];
            this.queue = this.queue.slice(1), this.h5 = e.k5, this.h7 = t(e);
            var i = Math.abs(e.from - e.to),
                s = null == e.easing ? this.getEasing(i) : e.easing,
                n = (null == e.duration ? this.e1.options.rotationAnimationDuration : e.duration) * this.g3(i);
            this.h7.animate({
              from: e.to
            }, {
              easing: s,
              ...
              step: t.proxy(this.k4, this),
              done: t.proxy(this.onDone, this),
              always: t.proxy(this.k9, this)
            });
          }
        }, this.Q = function () {
          return this.queue.length > 0 ? this.queue[this.queue.length - 1].k5 : this.h5;
        }, this.onStart = function () {
          this.k3 = !0;
        }, this.k4 = function (e) {
          t(this).trigger("step", e);
        }, this.onDone = function () {
          t(this).trigger("done", this.h5);
        }, this.k9 = function () {
          this.k3 = !1, this.h6(), this.h7 = null;
        }, this.addDistance = function (e) {
          this.distance.push({
            date: new Date(),
            value: e
          }), this.distance = t(this.distance).filter(function (t, e) {
            return new Date() - e.date < 5e3;
          });
        }, this.w_a = function () {
          for (var t = 0, e = new Date(), i = 0; i < this.distance.length; i++) {
            var s = this.distance[i];
            e - s.date < this.e1.options.rotationAnimationDuration && (t += s.value);
          }

          return t;
        }, this.g3 = function (t) {
          return this.e1.options.autorotation ? 1 : 0 == this.w_a() ? 1 : 1 / (this.w_a() / t);
        }, this.getEasing = function (t) {
          return this.g3(t) > .4 ? this.e1.options.rotationAnimationEasing : "linear";
        };
      };
    }(jQuery);
  }, {}],
  ...
  15: [function (t, e, i) {
    e.exports = function (t) {
      ...
      function e(t) {
        t.update = function () {
          for (var t = !1, e = 0; e < this.e1.a2.length; e++) {
            var i = this.e1.a2[e],
                s = null;
            i.size && (s = i.size), i.size = {
              height: i.b5.height(),
              width: i.b5.width()
            }, s && s.height == i.size.height && s.width == i.size.width || (t = !0);
          }
      ...
      return function (i) {
        e(this), this.e1 = i, this.interval = setInterval(t.proxy(this.update, this), 500), this.update();
      };
    }(jQuery);
  }, {}],
  16: [function (t, e, i) {
    e.exports = function (e) {
      ...
      function i(t) {
        t.moveToInternal = function (t) {
          var e = this.e1.options.selectedIndex - t,
              i = 0,
              s = !1;
          t > this.e1.options.selectedIndex ? i = this.e1.a2.length - t + this.e1.options.selectedIndex : (i = (this.e1.a2.length - this.e1.options.selectedIndex + t) * -1, s = !0);
          var n = e * this.w_a();
          (Math.abs(i) < Math.abs(e) || s && Math.abs(i) == Math.abs(e)) && (n = i * this.w_a()), this.e1.c2.h3(!0), this.e1.e2(), this.e1.f1.animate(0, n, t, 1 === Math.abs(i) ? null : "linear");
        }, t.moveBack = function () {
          var t = this.e1.f1.k3 ? this.e1.f1.Q() : this.e1.options.selectedIndex;
          return t--, t < 0 && (t = this.e1.a2.length + t), this.e1.c2.h3(!0), this.e1.e2(), this.e1.f1.animate(0, this.w_a(), t, null), !0;
        }, t.moveForward = function () {
          var t = this.e1.f1.k3 ? this.e1.f1.Q() : this.e1.options.selectedIndex;
          return t++, t >= this.e1.a2.length && (t -= this.e1.a2.length), this.e1.c2.h3(!0), this.e1.e2(), this.e1.f1.animate(0, -1 * this.w_a(), t, null), !0;
        }, t.consumeMotion = function (t) {
          var e = this.e1.b7(t),
              i = parseInt(t / this.w_a(), 10),
              s = this.e1.options.selectedIndex;
          this.e1.options.selectedIndex -= i;
          var n = s - this.e1.options.selectedIndex;
          return this.e1.options.selectedIndex < 0 && (this.e1.options.selectedIndex = this.e1.options.selectedIndex % this.e1.a2.length + this.e1.a2.length, n = this.e1.a2.length - this.e1.options.selectedIndex + s), this.e1.options.selectedIndex >= this.e1.a2.length && (this.e1.options.selectedIndex = this.e1.options.selectedIndex % this.e1.a2.length, n = this.e1.a2.length - s + this.e1.options.selectedIndex, n *= -1), s != this.e1.options.selectedIndex && this.e1.k8(), {
            distance: n * this.w_a(),
            k2: e
          };
        }, t.handleMotionEnd = function (t) {
          if (0 != t) {
            var e = this.e1.options.selectedIndex;
            Math.abs(t) > this.w_a() / 2 && (t < 0 ? e++ : e--);
            var i = !1;
            0 == this.e1.a2.length ? e = 0 : (e < 0 && (e = e % this.e1.a2.length + this.e1.a2.length, i = "back"), e >= this.e1.a2.length && (e %= this.e1.a2.length, i = "forward"));
            var s = 0;
            s = i ? "back" === i ? (this.e1.a2.length - e + this.e1.options.selectedIndex) * this.w_a() : (this.e1.a2.length - this.e1.options.selectedIndex + e) * this.w_a() * -1 : (this.e1.options.selectedIndex - e) * this.w_a();
            var n = Math.abs(this.e1.options.rotationAnimationDuration * (t / this.w_a()));
            n = Math.min(n, this.e1.options.rotationAnimationDuration / 2), this.e1.f1.animate(t, s, e, null, n);
          }
        }, t.alignElements = function (t) {
          if (0 == this.e1.a2.length || this.e1.options.selectedIndex < 0) return !1;
          this.e1.containerSize = this.e1.b9();
          var e = 0;
          "undefined" != typeof t && (e = t);

          for (var i = this.ca2(), n = this.k9(i), o = 0; o < this.e1.a2.length; o++) {
            this.e1.a2[o].isEndlessProcessed = !1;
          }

          for (var r = [], o = new s(this.e1, this.e1.options.selectedIndex); !o.isCycleCompleted(); o.moveNext()) {
            var a = this.q2(this.e1.a2[o.getCurrentIndex()], i + e, n);
            a && (this.e1.a2[o.getCurrentIndex()].isEndlessProcessed = !0), r[o.getCurrentIndex()] = a, i = this.b5(i, this.w_a());
          }

          i = this.ca2();

          for (var o = new s(this.e1, this.e1.options.selectedIndex - 1); !o.isCycleCompleted() && !this.e1.a2[o.getCurrentIndex()].isEndlessProcessed; o.movePrev()) {
            i = this.decrementValue(i, this.w_a()), r[o.getCurrentIndex()] = this.q2(this.e1.a2[o.getCurrentIndex()], i + e, n);
          }

          for (var o = 0; o < this.e1.a2.length; o++) {
            this.base.q1(!r[o], this.e1.a2[o]);
          }

          return this.setZIndexes(), !1;
        }, t.q1 = function (t) {};
      }

      var s = function s(t, e) {
        this.currentIndex = e, this.currentIndex == -1 && (this.currentIndex = t.a2.length - 1), this.iterations = 0, this.e1 = t, this.moveNext = function () {
          this.currentIndex++, this.currentIndex == this.e1.a2.length && (this.currentIndex = 0), this.iterations++;
        }, this.movePrev = function () {
          this.currentIndex--, this.currentIndex == -1 && (this.currentIndex = this.e1.a2.length - 1), this.iterations--;
        }, this.isCycleCompleted = function () {
          return Math.abs(this.iterations) >= this.e1.a2.length;
      ...
      return function (s) {
        var n = t("./rotation_logic_controller.js");
        this.base = new n(s), e.extend(this, this.base), i(this);
      };
    }(jQuery);
  }, {
    "./rotation_logic_controller.js": 31
    ...
    e.exports = function (t) {
      ...
      function e(t) {
        t.wwa = function () {
          ...
          return this.e1.options.distanceInFallbackMode;
        }, t.ca2 = function () {
          return 0;
        }, t.b5 = function (t, e) {
          return t + e;
        }, t.decrementValue = function (t, e) {
          return t - e;
        }, t.c3 = function () {
          return -1 * this.b9();
        }, t.b9 = function () {
          return (this.e1.containerSize.width + this.w_a()) / 2;
        }, t.q2 = function (t, e) {
          var i = e - t.size.width / 2 + this.e1.containerSize.width / 2,
              s = this.e1.containerSize.height / 2 - t.size.height / 2;
          t.b5.css({
            transform: "",
            left: i + "px",
            top: s + "px"
          });
          var n = e > this.c3() && e < this.b9();
          return n ? t.b5.show() : t.b5.hide(), n;
        }, t.destroy = function () {
          this.base.destroy();
      ...
      function i() {
        ...
        var t = document.createElement("div"),
            e = t.style,
            i = ["Webkit", "Moz", "O", "Ms", "ms"],
            s = i.length;
        if (void 0 !== t.style.perspective) return !0;

        for (; --s > -1;) {
          if (void 0 !== e[i[s] + "Perspective"]) return !0;
        }
      ...
      var s = null;
      return s = function s(i, _s) {
        this.base = _s, t.extend(this, this.base), e(this);
      }, s.fallback = function () {
        return !i();
      }, s;
    }(jQuery);
  ...
  18: [function (t, e, i) {
    e.exports = function (t) {
      ...
      function e(e) {
        e.update = function () {
          var e = this.e1.widget().width(),
              i = this.e1.widget().height(),
              s = null;

          if (0 != e && 0 != i && (null != this.e1.options.designedForWidth && null != this.e1.options.designedForHeight && (s = Math.min(e / this.e1.options.designedForWidth, i / this.e1.options.designedForHeight)), e != this.k8 || i != this._a1 || s != this.g3)) {
            var n = t(".theta-carousel-inner-container", this.e1.widget());
            null != s && (e /= s, i /= s, e / i < this.e1.options.designedForWidth / this.e1.options.designedForHeight ? i = e * (this.e1.options.designedForHeight / this.e1.options.designedForWidth) : e = i * (this.e1.options.designedForWidth / this.e1.options.designedForHeight), n.css({
              left: this.e1.widget().width() / 2 - e / 2,
              top: this.e1.widget().height() / 2 - i / 2
            })), e != this.k8 && (n.width(e), this.e1.invalidate(), this.k8 = e), i != this._a1 && (n.height(i), this.e1.invalidate(), this._a1 = i), s != this.g3 && (null == s ? n.css({
              transform: "translate3d(0px,0px, 100000px)",
              position: "static"
            }) : n.css({
              transform: "translate3d(0px,0px, 100000px) scale(" + s + ")",
              position: "relative"
            }), this.e1.invalidate(), this.g3 = s);
          }
        }, e.q8 = function () {
          return this.g3 ? this.g3 : 1;
        }, e.destroy = function () {
          clearInterval(this.interval);
        };
      }
      ...
      return function (i) {
        e(this), this.e1 = i, this.interval = setInterval(t.proxy(this.update, this), 200), this.update(), this.k8 = null, this._a1 = null, this.g3 = null;
      };
    }(jQuery);
  }, {}],
  19: [function (t, e, i) {
    e.exports = function (t) {
      ...
      return function (e) {
        this.e1 = e, this.c2 = [], this.h8 = 0, this.k3 = !1, this.L = !1, this.l = !1, this.L3 = function (t) {
          this.c2.push({
            date: new Date(),
            distance: t
          }), this.h1();
        }, this.stop = function () {
          this.l = !1, t(this).stop(!1, !1);
        }, this.k1 = function () {
          if (this.L) {
            this.L = !1, this.l = !0, t(this).stop(!1, !1);
            var e = this.l1.l3 + this.l1.l0 - this.h8,
                i = this.l1.l2 * Math.abs(e / this.l1.l0),
                s = 100 * this.e1.options.inertiaHighFriction,
                n = i * i / (2 * s);
            i < 0 && (n *= -1);
            var o = n / (i / 2);
            t(this).animate({
              ...
              duration: 1e3 * o,
              step: t.proxy(this.k4, this),
              complete: t.proxy(this.l4, this),
              fail: t.proxy(this.onFail, this)
            });
          }
        }, this.run = function (e) {
          var i = this.l5();
          if (this.c2 = [], 0 == i) return void t(this).trigger("complete");
          var s = 100 * this.e1.options.inertiaFriction,
              n = i * i / (2 * s);
          i < 0 && (n *= -1);
          var o = n / (i / 2);
          this.h8 = e, this.k3 = !0, this.L = !0, this.l1 = {
            l2: i,
            l0: n,
            l3: e
          }, t(this).animate({
          ...
          isNaN(e) || (this.h8 = e, t(this).trigger("step", e));
        }, this.l4 = function () {
          this.k3 = !1, t(this).trigger("complete");
        }, this.onFail = function () {
          this.l || (this.k3 = !1, t(this).trigger("stop"));
        }, this.h1 = function () {
          this.c2 = t(this.c2).filter(function (t, e) {
            return new Date() - e.date < 5e3;
          });
        }, this.l5 = function () {
          for (var t = 0, e = new Date(), i = 0; i < this.c2.length; i++) {
            var s = this.c2[i];
            e - s.date < 200 && (t += s.distance);
          }
    ...
    e.exports = function (t) {
      ...
      function e(t) {
        t.isVerticalRotation = function () {
          return this.e1.options.verticalRotation && !this.e1.q1.wwa();
        }, t.getSensitivity = function () {
          return this.e1.q1.wwa() ? 1 : this.e1.options.sensitivity / this.e1.c3.q8();
        }, t.isReadonly = function () {
          return !this.e1.options.enabled || this.e1.options.autorotation;
        }, t.L3 = function () {
          return this.e1.options.gesturesEnabled;
        }, t.h3 = function (t) {
          this.h9 = t;
        }, t.k3 = function () {
          return null == this.a2 || new Date() - this.a2 > 50;
        }, t.L1 = function () {
          this.a2 = new Date();
        }, t.h8 = function (t) {
          this.e1._a3.h8(t), this.initialX = t;
        }, t.a3 = function (t) {
          var e = this.initialX - t;
          e *= this.getSensitivity(), t = this.initialX - e, this.e1._a3.a3(t);
        }, t.onMousewheel = function (t) {
          if (this.e1.options.mousewheelEnabled && !this.isReadonly() && (t.preventDefault(), !this.e1.getIsInMotion())) {
            var e = !1,
                i = !1,
                s = t.originalEvent;
            t.deltaY && (1 == t.deltaY ? e = !0 : t.deltaY == -1 && (i = !0)), s.wheelDelta && (s.wheelDelta >= 120 ? e = !0 : s.wheelDelta <= -120 && (i = !0)), s.detail && (s.detail == -3 ? e = !0 : 3 == s.detail && (i = !0)), e && (this.getSensitivity() > 0 && this.e1.moveBack(), this.getSensitivity() < 0 && this.e1.moveForward()), i && (this.getSensitivity() < 0 && this.e1.moveBack(), this.getSensitivity() > 0 && this.e1.moveForward());
          }
        }, t.onKeyDown = function (t) {
          this.e1.options.keyboardEnabled && (this.isReadonly() || (t.which != this.getBackKey() && t.which != this.getForwardKey() || t.preventDefault(), this.e1._a3.isInMotion || this.e1._a3.inertia.k3 || new Date() - this.L5 < this.e1.options.minKeyDownFrequency || (this.L5 = new Date(), t.which == this.getBackKey() && (this.getSensitivity() > 0 && this.e1.moveBack(), this.getSensitivity() < 0 && this.e1.moveForward()), t.which == this.getForwardKey() && (this.getSensitivity() < 0 && this.e1.moveBack(), this.getSensitivity() > 0 && this.e1.moveForward()))));
        }, t.k8 = function (t) {
          this.isReadonly() || this.e1._a3.isInMotion || this.e1._a3.inertia.k3 || t.which != this.getBackKey() && t.which != this.getForwardKey() || this.e1.f1.R();
        }, t.destroyable = function (t, e) {
          return this.a2[t] = e, e;
        }, t.destroy = function () {
          for (var t in this.a2) {
            this.e1.widget().off(t, this.a2[t]);
          }
        }, t.getForwardKey = function () {
          return this.e1.options.verticalRotation ? 40 : 37;
        }, t.getBackKey = function () {
          return this.e1.options.verticalRotation ? 38 : 39;
        };
      }

      return function (i) {
        e(this), this.e1 = i, this.L5 = new Date(), this.a2 = null, this.h9 = !1, this.a2 = [], this.e1.widget().keyup(this.destroyable("keyup", t.proxy(this.k8, this))), this.e1.widget().keydown(this.destroyable("keydown", t.proxy(this.onKeyDown, this))), this.e1.widget().mousedown(this.destroyable("mousedown", t.proxy(function (t) {
          !this.isReadonly() && this.L3() && (this.e1.widget().focus(), this.h8(this.isVerticalRotation() ? t.pageY : t.pageX), t.preventDefault());
        }, this))), this.e1.widget().mousemove(this.destroyable("mousemove", t.proxy(function (t) {
          !this.isReadonly() && this.L3() && (this.k3() && (this.L1(), this.a3(this.isVerticalRotation() ? t.pageY : t.pageX)), t.preventDefault());
        }, this))), this.e1.widget().mouseleave(this.destroyable("mouseleave", t.proxy(function (t) {
          !this.isReadonly() && this.L3() && (this.h9 || (this.e1._a3.motionEnded(!0), t.preventDefault()));
        }, this))), this.e1.widget().mouseup(this.destroyable("mouseup", t.proxy(function (t) {
          !this.isReadonly() && this.L3() && (this.e1._a3.motionEnded(!0), t.preventDefault());
          ...
          !this.isReadonly() && this.L3() && this.h8(this.isVerticalRotation() ? t.originalEvent.touches[0].screenY : t.originalEvent.touches[0].screenX);
        }, this))), this.e1.widget().on("touchmove", this.destroyable("touchmove", t.proxy(function (t) {
          !this.isReadonly() && this.L3() && (this.k3() && (this.L1(), this.a3(this.isVerticalRotation() ? t.originalEvent.touches[0].screenY : t.originalEvent.touches[0].screenX)), t.preventDefault());
        }, this))), this.e1.widget().on("touchend", this.destroyable("touchend", t.proxy(function (t) {
          !this.isReadonly() && this.L3() && this.e1._a3.motionEnded(!0);
        }, this))), this.e1.widget().on("touchcancel", this.destroyable("touchcancel", t.proxy(function (t) {
          !this.isReadonly() && this.L3() && this.e1._a3.motionEnded(!0);
        }, this))), this.e1.widget().on("taphold", this.destroyable("taphold", function (t) {
          t.preventDefault();
        }));
      };
    }(jQuery);
  ...
  21: [function (t, e, i) {
    e.exports = function (e) {
      ...
      function i(t) {
        t.a1 = function () {
          return this.inertia.k3 || this.isInMotion;
        }, t.h8 = function (t) {
          this.inertia.k3 || (this.distance = 0), this.inertia.stop(), this.isInMotion = !0, this.L2 = t, this.raiseStart = !0;
        }, t.a3 = function (t) {
          this.isInMotion && (this.raiseStart && t != this.L2 && (e(this).trigger("start"), this.raiseStart = !1), this.inertia.L3(t - this.L2), this.a3Internal(t));
        }, t.a3Internal = function (t) {
          this.distance += t - this.L2, this.L2 = t;
          var e = this.k7(this.distance);
          this.distance -= e.distance, e.k2 && this.inertia.k3 && this.inertia.k1();
        }, t.motionEnded = function (t) {
          this.inertia.k3 || (this.isInMotion = !1, t ? this.inertia.run(this.L2) : (e(this).trigger("end", this.distance), this.distance = 0));
        }, t.inertiaStop = function () {
          this.isInMotion = !1;
        };
      }
      ...
      return function (s, n) {
        var o = t("./inertia.js");
        i(this), this.isInMotion = !1, this.L2 = null, this.distance = 0, this.k7 = n, this.inertia = new o(s), e(this.inertia).on("complete", e.proxy(this.motionEnded, this, !1)), e(this.inertia).on("stop", e.proxy(this.inertiaStop, this)), e(this.inertia).on("step", e.proxy(function (t, e) {
          this.a3Internal(e);
        }, this));
      };
    }(jQuery);
  ...
  22: [function (t, e, i) {
    e.exports = function (e) {
      ...
      return function (i, s) {
        ...
        e.extend(this, r), e.extend(this.settings, s), this.e7 = function (t) {
          var e = t * Math.PI * 2 / 360,
              i = this.settings.fi * t * Math.cos(e) / (2 * Math.PI),
              s = this.settings.fi * t * Math.sin(e) / (2 * Math.PI),
              n = -1 * Math.pow(t - this.a2(), 2) / this.settings.flatness;
          return new o(i, s, n);
        }, this.a2 = function () {
          return 450;
        }, this.c3 = function () {
    ...
    e.exports = function (e) {
      ...
      return function (i, s) {
        ...
        this.settings = {
          ...
          rotateElements: !1,
          endless: !1
        }, this.e1 = i, e.extend(this.settings, s), this.getContainerSize = function () {
          return this.e1.b9();
          ...
          return 0;
        }, this.b5 = function (t, e) {
          return t + e;
        }, this.decrementValue = function (t, e) {
          return t - e;
        }, this.getPoint = function (t) {
          var e = this.e7(t);
          e.x = e.x + this.settings.shiftX, e.y = e.y + this.settings.shiftY, e.z = e.z + this.settings.shiftZ;
          var i = null;
          return i = this.rotate({
            a: e.x,
            b: e.y
          }, {
            a: 0,
            b: 0
          }, this.settings.rotationAngleXY), e.x = i.a, e.y = i.b, i = this.rotate({
            a: e.z,
            b: e.y
          }, {
            a: 0,
            b: 0
          }, this.settings.rotationAngleZY), e.z = i.a, e.y = i.b, i = this.rotate({
            a: e.z,
            b: e.x
          }, {
            a: 0,
            b: 0
          }, this.settings.rotationAngleZX), e.z = i.a, e.x = i.b, e;
        }, this.rotate = function (t, e, i) {
          if (0 == i) return t;
          var s = i * (Math.PI / 180),
              n = Math.cos(s),
              o = Math.sin(s),
              r = n * (t.a - e.a) - o * (t.b - e.b) + e.a,
              a = o * (t.a - e.a) + n * (t.b - e.b) + e.b;
          return t.a = r, t.b = a, t;
        }, this.a2Rotation = function () {
          if (!this.settings.rotateElements) return null;
          if (0 == this.settings.rotationAngleZY && 0 == this.settings.rotationAngleZX && 0 == this.settings.rotationAngleXY) return null;
          var t = new o();
          t.x = this.settings.rotationAngleZY, t.y = -1 * this.settings.rotationAngleZX, t.z = -1 * this.settings.rotationAngleXY;
          var e = -1 * t.length();
          return new n(t, e);
        };
      };
  ...
  24: [function (t, e, i) {
    e.exports = function (e) {
      ...
      return function (i, s) {
        ...
        e.extend(this, r), e.extend(this.settings, s), this.e7 = function (t) {
          var e = (t * t * t + 20 * t) / (1e3 * this.settings.wideness),
              i = -2 * Math.abs(e);
          return new o(t, e, i);
        };
      };
  ...
  25: [function (t, e, i) {
    e.exports = function (e) {
      ...
      return function (i, s) {
        ...
        e.extend(this, h), e.extend(this.settings, s), this.e7 = function (t) {
          var e = Math.abs(t - this.c3()),
              i = Math.abs(this.b9() - this.c3()),
              s = Math.min(e / i, 1),
              n = this.settings.xyPathBezierPoints,
              h = this.settings.xyArcLengthBezierPoints,
              l = this.settings.xzPathBezierPoints,
              u = r(n.p1, n.p2, n.p3, n.p4),
              c = r(l.p1, l.p2, l.p3, l.p4);
          s = a(s, h.p1, h.p2, h.p3, h.p4).y / 100;
          var p = a(s, n.p1, n.p2, n.p3, n.p4),
              d = this.K(p.x, u.minX, u.maxX),
              f = this.K(p.y, u.minY, u.maxY),
              m = a(s, l.p1, l.p2, l.p3, l.p4).y;
          return m = this.K(m, c.minY, c.maxY), d = this.settings.width * d - this.settings.width / 2, f = this.settings.height * f * -1, m = this.settings.depth * m * -1, new o(d, f, m);
    ...
    e.exports = function (e) {
      ...
      return function (i, s) {
        ...
        e.extend(this, r), e.extend(this.settings, s), this.e7 = function (t) {
          t *= -1, t -= 180;
          var e = t * Math.PI * 2 / 360,
              i = this.settings.b * Math.sin(e),
              s = this.settings.a * Math.cos(e);
          return new o(s, 0, i);
        }, this.a2 = function () {
          return 90;
        }, this.c3 = function () {
  ...
  28: [function (t, e, i) {
    e.exports = function (e) {
      ...
      return function (i, s) {
        ...
        e.extend(this, r), e.extend(this.settings, s), this.e7 = function (t) {
          var e = -1 * t * t * (1 / this.settings.wideness);
          return new o(t, 0, e);
        };
      };
    }(jQuery);
    ...
    e.exports = function (e) {
      ...
      return function (t, e) {
        this.vector = t, this.angle = e, this.getString = function () {
          return i.isFF() ? "" : "rotate3d(" + this.vector.x + ", " + this.vector.y + ", " + this.vector.z + ", " + this.angle + "deg)";
        };
      };
    }(jQuery);
  }, {
    ...
    e.exports = function (t) {
      ...
      function e(t) {
        t.wwa = function () {
          ...
          return this.e1.options.distance;
        }, t.ca2 = function () {
          return this.e1.path.a2();
        }, t.b5 = function (t, e) {
          return this.e1.path.b5(t, e);
        }, t.decrementValue = function (t, e) {
          return this.e1.path.decrementValue(t, e);
        }, t.c3 = function () {
          return this.e1.path.c3();
        }, t.b9 = function () {
          return this.e1.path.b9();
        }, t.moveTo = function (t) {
          if (!this.e1._a3.a1() && (this.e1.f1.R(), this.e1.f1.completeCurrentImmediately(), t != this.e1.options.selectedIndex)) {
            if (t == this.e1.options.selectedIndex + 1) return void this.e1.moveForward();
            if (t == this.e1.options.selectedIndex - 1) return void this.e1.moveBack();
            t = Math.max(0, t), t = Math.min(t, this.e1.a2.length - 1), this.moveToInternal(t);
          }
        }, t.moveToInternal = function (t) {
          var e = this.w_a() * (this.e1.options.selectedIndex - t);
          this.e1.c2.h3(!0), this.e1.e2(), this.e1.f1.animate(0, e, t, "linear");
        }, t.moveBack = function () {
          var t = this.e1.f1.k3 ? this.e1.f1.Q() : this.e1.options.selectedIndex;
          return t > 0 && (t--, this.e1.c2.h3(!0), this.e1.e2(), this.e1.f1.animate(0, this.w_a(), t, null), !0);
        }, t.moveForward = function () {
          var t = this.e1.f1.k3 ? this.e1.f1.Q() : this.e1.options.selectedIndex;
          return t < this.e1.a2.length - 1 && (t++, this.e1.c2.h3(!0), this.e1.e2(), this.e1.f1.animate(0, -1 * this.w_a(), t, null), !0);
        }, t.consumeMotion = function (t) {
          var e = this.e1.b7(t),
              i = this.w_a(),
              s = parseInt(t / i, 10),
              n = this.e1.options.selectedIndex;
          return this.e1.options.selectedIndex -= s, this.e1.options.selectedIndex = Math.max(0, this.e1.options.selectedIndex), this.e1.options.selectedIndex = Math.min(this.e1.options.selectedIndex, this.e1.a2.length - 1), n != this.e1.options.selectedIndex && this.e1.k8(), {
            distance: (n - this.e1.options.selectedIndex) * i,
            k2: e
          };
        }, t.handleMotionEnd = function (t) {
          if (0 != t) {
            var e = this.e1.options.selectedIndex;
            Math.abs(t) > this.w_a() / 2 && (t < 0 ? e++ : e--), 0 == this.e1.a2.length ? e = 0 : (e = Math.max(0, e), e = Math.min(e, this.e1.a2.length - 1));
            var i = (this.e1.options.selectedIndex - e) * this.w_a(),
                s = Math.abs(this.e1.options.rotationAnimationDuration * (t / this.w_a()));
            s = Math.min(s, this.e1.options.rotationAnimationDuration / 2), this.e1.f1.animate(t, i, e, null, s);
          }
        }, t.alignElements = function (t) {
          if (0 == this.e1.a2.length || this.e1.options.selectedIndex < 0) return !1;
          this.e1.containerSize = this.e1.b9();
          ...
          "undefined" != typeof t && (e = t);
          var i = !1;
          (0 == this.e1.options.selectedIndex && e > 0 || this.e1.options.selectedIndex == this.e1.a2.length - 1 && e < 0) && (e = Math.pow(Math.abs(e), .7) * (e / Math.abs(e)), i = !0);
          var s = this.ca2(),
              n = 0;
          (0 == this.e1.options.selectedIndex && e > 0 || this.e1.options.selectedIndex == this.e1.a2.length - 1 && e < 0) && (n = e);

          for (var o = this.k9(s + n), r = this.e1.options.selectedIndex; r < this.e1.a2.length; r++) {
            this.q2(this.e1.a2[r], s + e, o), s = this.b5(s, this.w_a());
          }

          s = this.ca2();

          for (var r = this.e1.options.selectedIndex - 1; r >= 0; r--) {
            s = this.decrementValue(s, this.w_a()), this.q2(this.e1.a2[r], s + e, o);
          }

          return this.setZIndexes(), i;
        }, t.q2 = function (t, e, i) {
          if (this.setElementVisibility(i, t, e)) {
            var n = this.e1.path.getPoint(e),
                o = new s();
            o.translateZ = n.z * this.e1.options.scaleZ, o.translateX = n.x * this.e1.options.scaleX + this.e1.containerSize.width / 2 - t.size.width / 2, o.translateY = n.y * this.e1.options.scaleY + this.e1.containerSize.height / 2 - t.size.height / 2;
            var r = this.e1.path.a2Rotation();
            r && o.rotations.push(r), "scale" == this.e1.options.mode3D && (o.scale = this.e1.options.perspective / (this.e1.options.perspective - o.translateZ), o.translateZ = 0);

            for (var a = 0; a < this.e1.h4.length; a++) {
              "positioning" === this.e1.h4[a].applyPhase && this.e1.h4[a].apply(o, t, e);
            }

            return o.apply(t, this.e1.options.perspective, this.e1.containerSize.width, this.e1.containerSize.height), t.location = n, !0;
          }

          return !1;
        }, t.setZIndexes = function () {
          for (var t = [], e = 0; e < this.e1.a2.length; e++) {
            var i = this.e1.a2[e];
            i.location && t.push(i);
          }
          ...
          for (var e = 0; e < t.length; e++) {
            t[e].b5.get(0).style.zIndex = e;
          }
        }, t.k9 = function (t) {
          var e = t,
              i = [];
          return null != this.e1.options.numberOfElementsToDisplayLeft && i.push({
            from: this.decrementValue(e, this.w_a() * (this.e1.options.numberOfElementsToDisplayLeft + 1)),
            to: this.decrementValue(e, this.w_a() * this.e1.options.numberOfElementsToDisplayLeft),
            hide: "before"
          }), null != this.e1.options.numberOfElementsToDisplayRight && i.push({
            from: this.b5(e, this.w_a() * this.e1.options.numberOfElementsToDisplayRight),
            to: this.b5(e, this.w_a() * (this.e1.options.numberOfElementsToDisplayRight + 1)),
            hide: "after"
          }), i;
        }, t.setElementVisibility = function (t, e, i) {
          var s = e.b5,
              n = !1;
          if (null != this.c3() && i < this.c3() || null != this.b9() && i > this.b9()) n = !0;else {
            0 == t.length && s.css({
              opacity: 1
            });
            ...
            for (var o = 0; o < t.length; o++) {
              ...
              if ("before" == r.hide && i <= r.from || "after" == r.hide && i >= r.to) {
                n = !0;
                break;
              }
              ...
              if (i > r.from && i < r.to) {
                var a = r.to - r.from,
                    h = Math.abs(i - ("after" == r.hide ? r.from : r.to)),
                    l = (a - h) / a;
                s.css({
                  opacity: l
                });
          ...
          for (var t = 0; t < this.e1.a2.length; t++) {
            this.e1.a2[t].b5.css({
              ...
              transform: "",
              opacity: "1"
            }), this.e1.a2[t].b5.show();
          }
        }, t.q1 = function (t, e) {
          t ? e.b5.hide() : e.b5.show();
        };
      }
  ...
  33: [function (t, e, i) {
    ...
    s.X = {
      ...
      return function () {
        this.translateX = 0, this.translateY = 0, this.translateZ = 0, this.scale = 1, this.scaleX = 1, this.scaleY = 1, this.scaleZ = 1, this.rotations = [], this.wl1a = function (t, e, i, n) {
          var o = s[n];
          if (0 == t) return 1;
          var r = 0,
              a = 0;
          if (e /= 2, o.persp == t && o.width == e) r = o.val;else {
            var h = Math.sqrt(t * t + e * e);
            a = Math.asin(e / h), r = Math.tan(1.5708 - a), o.persp = t, o.width = e, o.val = r;
          }
          var l = -1 * (1 / r * i),
              u = e + l;
          return e / u;
        }, this.apply = function (t, e, i, s) {
          var n = e / (e - this.translateZ),
              o = t.size.width,
              r = t.size.height,
              a = this.wl1a(e, i, this.translateZ, "X"),
              h = this.wl1a(e, s, this.translateZ, "Y"),
              l = this.translateX + o / 2,
              u = this.translateY + r / 2;
          l -= i / 2, u -= s / 2, l *= a, u *= h, l = l + i / 2 - o / 2, u = u + s / 2 - r / 2;
          var c = "translate3d(" + l + "px, " + u + "px, 0px)";
          1 != this.scale && (c += " scale(" + this.scale + "," + this.scale + ")");

          for (var p = 0; p < this.rotations.length; p++) {
            c += " " + this.rotations[p].getString();
          }

          c += " scale(" + n + ", " + n + ")", 1 != this.scaleX && (c += " scaleX(" + this.scaleX + ")"), 1 != this.scaleY && (c += " scaleY(" + this.scaleY + ")"), 1 != this.scaleZ && (c += " scaleZ(" + this.scaleZ + ")"), t.element.style.transform = c, t.element.style.webkitTransform = c, t.element.style.msTransform = c;
        };
      };
    }(jQuery);
  }, {}],
  34: [function (t, e, i) {
    e.exports = function (t) {
      ...
      var e = function e() {
        this.e6 = function (t, e) {
          for (var i = e.split("."), s = t, n = 0; n < i.length; n++) {
            s = s[i[n]];
          }

          return s;
        }, this.e5 = function (t, e, i) {
          for (var s = e.split("."), n = t, o = 0; o < s.length - 1; o++) {
            n = n[s[o]];
          }
  ...
  35: [function (t, e, i) {
    e.exports = function (t) {
      ...
      return function () {
        this.x = 0, this.y = 0, this.z = 0, this.e7 = function (t, e) {
          ...
          var e = this.x * t.x + this.y * t.y + this.z * t.z,
              ...
              n = e / (i * s),
              o = Math.acos(n);
          return this.z > t.z && (o *= -1), 180 * o / Math.PI;
        }, this.Qz2 = function () {
          var t = new vector();
