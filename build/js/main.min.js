...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var collectionFavorites = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](".main-page-collection__favorites-slider", {
    effect: "coverflow",
    grabCursor: true,
    centeredSlides: true,
    initialSlide: 2,
    ...
    on: {
      slideChange: function slideChange() {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".swiper-slide").removeClass("swiper-slide-prev-2 swiper-slide-next-2");
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.swiper-slide[data-swiper-slide-index="' + realIndex + '"]').prev().prev().addClass("swiper-slide-prev-2");
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.swiper-slide[data-swiper-slide-index="' + realIndex + '"]').next().next().addClass("swiper-slide-next-2");
      }
    }
  }); // (function () {
  //   "use strict";
