...
document.addEventListener("DOMContentLoaded", function () {
  ...
  personSlider.forEach(function (element) {
    ...
    var sliderThumbs = new swiper_bundle__WEBPACK_IMPORTED_MODULE_1__["default"](element.querySelector(".department__person-slider-thumbs"), _defineProperty({
      initialSlide: 0,
      slidesPerView: "auto",
      spaceBetween: 17,
      slideToClickedSlide: true,
  ...
  (function ($) {
    $.fn.vmenuModule = function (option) {
      ...
      item.unbind("click").on("click", function (e) {
        ...
        if (options.autohide) {
          a.parent().parent().find("button[data-option='on']").parent("li").children("ul").slideUp(options.Speed / 1.2, function () {
  ...
  })(jQuery); //трансформация списка в аккордион в мобиле


  function accordion() {
    var content = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".accordion--mobile .accordion-content");

    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).width() < 1024) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".js-accordion--mobile").vmenuModule({
        Speed: 400,
        autostart: false,
        autohide: true
      });
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".js-accordion").vmenuModule({
      Speed: 400,
      autostart: false,
      autohide: true
    });
